package com.raga.serverproductmanagement.jwt;
...
public class JwtTokenProvider {
    ...
    public String generateToken(Authentication auth){ //Authentication keeps credentials and roles of authenticated users
    ...
    public Authentication genAuthentication(HttpServletRequest request){
